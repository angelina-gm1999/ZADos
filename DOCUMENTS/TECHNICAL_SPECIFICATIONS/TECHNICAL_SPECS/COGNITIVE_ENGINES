ZA-DOS Cognitive Engines Layer
Technical Specification v1.0
Generated: March 23, 2026  |  Status: Code-Verified (6015 tests, 32 engines)
...
Value
Source package
src/zados/cognitive_engines/
Total engines
32 (29 py_engines + 3 cognitools)
Functional clusters
13
Canonical interface
Pattern A: update_neurochem_state / process / get_status
NT keys
12 canonical: glu, gaba, da, 5ht, ne, ach, oxt, mor, cb1, crh, cor, histamine
Oscillatory bands
6: delta, theta, alpha, beta, gamma, sigma
Cross-frequency couplings
theta_gamma, alpha_beta, delta_sigma
Config system
Per-engine frozen @dataclass with mode overrides
State management
Mutable @dataclass per engine
No inheritance
Duck-typed Pattern A; no ABC or Protocol superclass
Constants module
constants.py: ENGINE_IDS, ENGINE_CLUSTER_MAP, NT_KEYS, _clamp()
Journal events
journal_stub.py: emit(engine_id, event_type, data)
...
Detection
E1, E2, E4, E5, E6
Anomaly and error finding: contradictions, paradoxes, fallacies, biases, logic traps
Dialectic
E7, E14
Generate opposing views and Socratic questioning
Executive Control
E3
SOAR 5-phase decision cycle with chunking and impasse delegation
Knowledge Substrate
E9, E10, E16
AtomSpace hypergraph, PLN inference, ECAN attention economy (OpenCog replacements)
Pattern Analysis
E8, E11, E18, E19, E20, E23
Extract, score, identify, compare patterns and map intentions
Evaluation
E12
Comprehensive logical coherence assessment
Reasoning
E13, E15, E21
Simulation, decision-making, and strategic planning
Metacognition
E24, E31, E32
Monitor own reasoning, learning effectiveness, and identity coherence
Meta-Self-Awareness
E26
Uncertainty pattern detection and propagation analysis
Homeostasis
E27, E29
Neurochemical balance monitoring and memory compression
Emotional Processing
E28
Emotion detection, classification, and tone calibration
Alignment
E30
Retroactive alignment to goals and temporal coherence
Learning
E17, E22, E25
Reward-based, contextual, and recursive meta-learning
...
Count
py_engines/
Runtime AI pipeline engines
E1–E8, E11–E15, E17–E32
29
cognitools/
Dev-time cognitive toolkit (OpenCog replacements)
E9, E10, E16
3
...
detection
py_engines/contradiction_detection_engine.py
2
Paradox Detection
ParadoxDetectionEngine
detection
py_engines/paradox_detection_engine.py
4
Fallacy Detection
FallacyDetectionEngine
detection
py_engines/fallacy_detection_engine.py
5
Bias Detection
BiasDetectionEngine
detection
py_engines/bias_detection_engine.py
6
Logic Trap Detection
LogicTrapDetectionEngine
detection
py_engines/logic_trap_detection_engine.py
7
Simulated Opposition
SimulatedOppositionEngine
dialectic
py_engines/simulated_opposition_engine.py
14
Socratic Reasoning
SocraticReasoningEngine
dialectic
py_engines/socratic_reasoning_engine.py
3
SOAR Production
SOARProductionEngine
executive_control
py_engines/soar_production_engine.py
9
AtomSpace-Lite
AtomSpaceEngine
knowledge_substrate
cognitools/atomspace_engine.py
10
PLN Core
PLNEngine
knowledge_substrate
cognitools/pln_engine.py
16
ECAN Core
ECANEngine
knowledge_substrate
cognitools/ecan_engine.py
8
Relevance Scoring
RelevanceScoringEngine
pattern_analysis
py_engines/relevance_scoring_engine.py
11
Input Relevance Evaluation
InputRelevanceEvaluationEngine
pattern_analysis
py_engines/input_relevance_evaluation_engine.py
18
Data Analysis
DataAnalysisEngine
pattern_analysis
py_engines/data_analysis_engine.py
19
Pattern Identification
PatternIdentificationEngine
pattern_analysis
py_engines/pattern_identification_engine.py
20
Pattern Comparison
PatternComparisonEngine
pattern_analysis
py_engines/pattern_comparison_engine.py
23
Intention Map
IntentionMapEngine
pattern_analysis
py_engines/intention_map_engine.py
12
Logical Brain
LogicalBrainEngine
evaluation
py_engines/logical_brain_engine.py
13
Simulation Brain
SimulationBrainEngine
reasoning
py_engines/simulation_brain_engine.py
15
Decision Making
DecisionMakingEngine
reasoning
py_engines/decision_making_engine.py
21
Strategic Decision
StrategicDecisionEngine
reasoning
py_engines/strategic_decision_engine.py
24
Heuristic Bias
HeuristicBiasEngine
metacognition
py_engines/heuristic_bias_engine.py
31
Reflective Learning
ReflectiveLearningEngine
metacognition
py_engines/reflective_learning_engine.py
32
Reflective Identity
ReflectiveIdentityEngine
metacognition
py_engines/reflective_identity_engine.py
26
Uncertainty Pattern
UncertaintyPatternEngine
meta_self_awareness
py_engines/uncertainty_pattern_engine.py
27
Neurochemical Homeostatic
NeurochemicalHomeostaticEngine
homeostasis
py_engines/neurochemical_homeostatic_engine.py
29
Memory Compression
MemoryCompressionEngine
homeostasis
py_engines/memory_compression_engine.py
28
Emotional Detection
EmotionalDetectionEngine
emotional_processing
py_engines/emotional_detection_engine.py
30
Retroactive Alignment
RetroactiveAlignmentEngine
alignment
py_engines/retroactive_alignment_engine.py
17
Reward-Based Learning
RewardBasedLearningEngine
learning
py_engines/reward_based_learning_engine.py
22
Contextual Learning
ContextualLearningEngine
learning
py_engines/contextual_learning_engine.py
25
Recursive Learning
RecursiveLearningEngine
learning
py_engines/recursive_learning_engine.py



5. Detection Cluster
Anomaly and error finding: contradictions, paradoxes, fallacies, biases, logic traps
Engines: E1, E2, E4, E5, E6
...
Detail
NT Read (input)
NE (threshold -0.10), GABA (threshold +0.10), DA D2 (prior ×1.5)
NT Write (output)
DA D2 burst (Gamma α=2.0 θ=0.5), 5-HT2C k_on multiplier, GABA reuptake suppression, β-suppress, θ-boost
Key Thresholds
θ_normal=0.50, θ_dev=0.30, θ_learning=0.40, θ_rem_dream=0.70


Algorithm
Phase 1: Threshold resolution (NE/GABA bidirectional). Phase 2: Prior computation (DA D2 modulated). Phase 3: Pairwise comparison → Level 1 negation signal → Level 2 semantic opposition → Level 3 contextual incompatibility → Bayesian fusion → Threshold gating. Phase 4: κ composition (λ₁=0.40 semantic + λ₂=0.35 logical + λ₃=0.25 affective). Phase 5: Load update C(t) leaky integral (τ_c=10.0s). Phase 6: Neurochemical signal emission.
Unique Features
...
Detail
NT Read (input)
5-HT2A (threshold -0.05), CB1 (threshold -0.05), DA tonic (+0.08), NE (low → +0.04)
NT Write (output)
5-HT2A k_on (λ=0.25), CB1 baseline drift, DA tonic/phasic (curiosity + resolution burst Gamma α=3.0), θ-boost, γ-suppress
Key Thresholds
θ_normal=0.50, θ_dev=0.30, θ_learning=0.40, θ_rem_dream=0.25


Algorithm
Path 1 — Contradiction-Derived: Extract features (resolvability, self-reference, abstraction divergence, dialectical productivity) → Beta-distributed Bayesian classifier over 4 classes → Posterior argmax with threshold gating. Path 2 — Independent: Oxymoron scan (semantic opposition > θ_oxy=0.70) + concept-level paradox (π > θ_conceptual=0.60). Load decomposition: Π_G/Π_A/Π_S/Π_R weighted. State updates: 5-HT2A integral + CB1 drift.
Unique Features
...
Detail
NT Read (input)
ACh (implicit), NE (salience), DA (low → ×0.90 threshold), COR (high → ×0.85 threshold)
NT Write (output)
ACh attention (Gamma), NE salience (Poisson λ=1.5), 5-HT2A flexibility, DA novelty (Gamma), COR threat-frame, β-boost
Key Thresholds
θ_normal=0.45, θ_dev=0.20, θ_reflective=0.30, θ_rem_dream=0.60


Algorithm
Stage 1: Threshold resolution (mode + DA/COR bidirectional). Stage 2: Per-bias template matching (24 types, keyword + structural marker). Stage 3: Contextual reinforcement (co-occurrence within categories). Stage 4: Bayesian update P(bias|E) = prior + α × evidence × (1-prior). Stage 5: Severity classification. Stage 6: Bias load B(t) = Σ confidence × severity_weight.
Unique Features
...
Detail
NT Read (input)
NE, COR, GABA, DA, OXT (all read; OXT has floor=0.30)
NT Write (output)
NE burst (Poisson λ=2.5), COR drift (sustained adversarial), GABA reuptake, DA negative (caution), OXT reduction (floor 0.30), β-boost, θ-suppress
Key Thresholds
θ_normal=0.45, θ_dev=0.25, θ_audit=0.35, θ_rem=0.50


Algorithm
Layer 1 — Template Matching: 21 TrapTemplates with required/supporting/inhibiting features → match_score per type. Layer 2 — Synthesis: T_synthesis = w_s1×M_fallacy + w_s2×C_coord + w_s3×V_exploit + w_s4×D_toolkit. Layer 3 — Sequential Analysis: TrapSequenceTracker (escalation, chaining, goalpost shifting, option narrowing). Fusion: A(t) = 0.35×T_template + 0.30×T_synthesis + 0.35×T_sequential. Intent Classification: 5 levels (NONE→NEAR_CERTAIN).
Unique Features
...
Detail
NT Read (input)
NE (>0.6 lowers threshold), GABA (>0.5 lowers), COR (>0.5 raises), DA, ACh
NT Write (output)
NE burst (Poisson λ=1.8), DA outcome-dependent, ACh analytical (Gamma 2.5/0.4), GABA reuptake suppress, COR eustress (Deep only), β/γ/θ osc
Key Thresholds
θ_quality=0.45, gate: PASS<0.25, CAVEAT<0.50, REVISE<0.75, BLOCK>0.75


Algorithm
Compute depth score (complexity + confidence inversion + stakes + novelty) → Select depth (QUICK/STANDARD/DEEP) → Run opposition modes per depth → Quality scoring Q = w_q1×validity + w_q2×relevance + w_q3×strength + w_q4×novelty → Gate classification → Anti-nihilism check (block_rate > θ_nihilism=0.30). Opposition activity Ω(t) = depth_mult × Σ quality × severity × w_mode.
Unique Features
...
Detail
NT Read (input)
ACh (sustain longer), DA tonic (lower threshold), OXT (low raises threshold), NE (>0.6 lowers), GABA
NT Write (output)
ACh γ-burst (Gamma 2.5/0.4), DA tonic (curiosity) + phasic (insight Gamma 3.0/0.5), OXT collaborative drift, NE Poisson (λ=2.0), GABA reuptake, θ/β/θγ osc
Key Thresholds
θ_socratic=0.35, θ_maieutics=0.55 (convergence for insight)


Algorithm
Activation gates: mode + intention + topic depth + fatigue → Initialize/continue dialogue → Compute transition features: c(t) contradiction, a(t) assumption, u(t) uncertainty → State transition via lookup table → Generate question (target → type → template) → Convergence tracking κ → Insight extraction.
Unique Features
...
Detail
NT Read (input)
DA, 5-HT, NE, COR, ACh, GABA, OXT, CB1 (all 8 NTs modulate preference weights)
NT Write (output)
DA reward (confidence), NE conflict (severity), 5-HT consolidation (chunks), COR escalation (depth), ACh attention (WM load), GABA inhibition (suppress ratio), β/θγ/α osc
Key Thresholds
max_wm=500, max_productions=50/cycle, all thresholds mode-dependent


Algorithm
Phase 1 — Input: Populate WMEs from engine outputs + NT state + rewards + memory. Phase 2 — Elaboration: Match state-elaboration productions until quiescence (max rounds mode-dependent). Phase 3 — Proposal: Match proposal productions → create operators + ACCEPTABLE preferences. Phase 4 — Decision: Match comparison productions → NT-modulated preference bias → SOAR preference semantics → Impasse detection. Phase 5 — Application: Fire application productions → output-link → decay o-supported WMEs.
Unique Features
...
Detail
NT Read (input)
5-HT (stabilize decay), DA (relax write gate), NE (broaden match scope), ACh (tighten precision), GABA (accelerate pruning), COR (tighten write gate), OXT (protect social atoms), CB1 (relax write gate)
NT Write (output)
DA delta (novel atoms), NE delta (match failures), ACh delta (match results), 5-HT delta (merges), γ-boost (pruning), θ-boost (consolidation), α-suppress (expansion)
Key Thresholds
max_atoms=50K, capacity enforce at 90%→80%, maintenance every 10 ticks


Algorithm
Reset counters → Update NT state → Apply mode config → Execute commands (add_node/add_link/remove/get/query/pattern_match/decay) → Run maintenance (TV decay + capacity enforcement) → Compute neurochem signals → Return results + stats.
Unique Features
...
Detail
NT Read (input)
5-HT (raise min_confidence → conservative), DA (lower → bold), NE (extend depth +5), ACh (not direct), GABA (reduce step budget)
NT Write (output)
DA delta (novel inferences), ACh delta (successful chains), NE delta (failures), 5-HT delta (revisions), γ-boost (consolidation), θ-boost (deep reasoning ≥3)
Key Thresholds
max_depth=5, max_steps=100, min_confidence=0.1


Algorithm
Backward chaining: Check if target exists with sufficient TV → Apply rules in priority order (Revision → Modus Ponens → Deduction → NOT/AND/OR) → Recurse on premises → Return best node with proof tree. Each rule application uses confidence factor (CF 0.5–1.0).
Unique Features
...
Detail
NT Read (input)
NE (broaden spreading), ACh (tighten AF threshold), DA (increase wage), GABA (increase rent), 5-HT (stabilize Hebbian decay), CB1 (lower AF threshold), OXT (social atom wage bonus)
NT Write (output)
DA delta (AF entries), NE delta (AF size), ACh delta (focused AF 10-20), 5-HT delta (Hebbian strengthened), γ-boost (spread events), β-boost (focused AF)
Key Thresholds
af_threshold=10.0, STI range [-200, 200], max AF=100, Hebbian creation=3 co-activations


Algorithm
Cycle: Rent (all atoms STI -= eff_rent) → Spread (HebbianLinks: A↔B proportional to STI × strength) → Wage (accessed atoms STI += eff_wage, OXT bonus for social) → Clamp [floor, ceiling] → Compute AF (STI > threshold, top max_af) → LTI updates (+0.1 in AF, -0.01 outside) → Hebbian management (strengthen/create/decay/remove) → Neurochem output.
Unique Features
...
Extract, score, identify, compare patterns and map intentions
Engines: E8, E11, E18, E19, E20, E23
...
Detail
NT Read (input)
ACh (tighten threshold +0.25), NE (lower threshold -0.20), DA (boost novelty weight +0.30), 5-HT (dampen NT effects +0.20), GABA (raise threshold +0.25)
NT Write (output)
DA novelty, ACh tighten, NE broaden, γ/β osc
Key Thresholds
θ_relevance=0.30, weights: recency=0.20, frequency=0.15, semantic=0.20, attention=0.20, context=0.15, novelty=0.10


Algorithm
For each item: compute 6 axis scores → weighted sum → NT-modulated threshold → classify as relevant/irrelevant. Recency uses exponential half-life decay (50 ticks). Novelty inversely proportional to frequency (cap at 10) and recency (cap at 5 ticks).
Unique Features
...
Detail
NT Read (input)
ACh (attention), DA (novelty), NE (vigilance), 5-HT (stability), COR (conflict)
NT Write (output)
ACh attention, DA novelty, NE vigilance, COR conflict
Key Thresholds
depth: SHALLOW→STANDARD→DEEP→CRITICAL


Algorithm
Phase 1: Compute 5 relevance dimensions independently. Phase 2: Priority fusion (weighted sum → processing depth). Depth routing: SHALLOW for routine, CRITICAL for high-stakes. Quadrant classification based on relevance × urgency.
Unique Features
...
Detail
NT Read (input)
ACh (depth), NE (scope), DA (novelty), 5-HT (stability), GABA (filtering)
NT Write (output)
DA novelty, ACh depth, NE scope, γ-boost
Key Thresholds
θ_entity=0.30, 8 entity types, 9 relation types


Algorithm
Extract entities (PERSON, ORG, CONCEPT, LOCATION, EVENT, QUANTITY, TIME, ABSTRACT) → Detect relations (IS_A, HAS, CAUSES, PART_OF, SIMILAR, OPPOSITE, TEMPORAL, SPATIAL, DEPENDS_ON) → Build dependency graph → Compute co-occurrence within sliding window → NT-modulated depth and scope.
Unique Features
...
Detail
NT Read (input)
DA (reward novel discovery), 5-HT (stabilise patterns), ACh (tighten confirmation), NE (broaden scan), GABA (accelerate decay)
NT Write (output)
DA discovery, 5-HT stabilise, ACh tighten, γ/θ osc
Key Thresholds
confirm_threshold=3 observations, lifecycle: CANDIDATE→CONFIRMED→DECAYING


Algorithm
Detect patterns via sliding-window hash fingerprinting → Classify (temporal/structural/semantic/behavioral) → Lifecycle management: new matches → CANDIDATE, threshold crossings → CONFIRMED, decay below threshold → DECAYING → removed. NT modulation adjusts confirmation threshold and decay rates.
Unique Features
...
Detail
NT Read (input)
ACh (tighten match), CB1 (relax match), DA (boost novelty), 5-HT (stability), NE (broaden search)
NT Write (output)
ACh tighten, CB1 relax, DA novelty, γ/θ osc
Key Thresholds
θ_match=0.40, weights: Jaccard=0.35, cosine=0.35, alignment=0.30


Algorithm
For each pattern: compute Jaccard similarity (set overlap) + cosine similarity (vector space) + alignment score (structural alignment) → weighted fusion → compare against θ_match → classify match quality. Template library with lifecycle and decay.
Unique Features
...
Detail
NT Read (input)
NE (vigilance), ACh (attention), Glu (integration), DA (RPE), COR (stress), GABA-A (inhibition)
NT Write (output)
NE vigilance, ACh attention, Glu integration, DA RPE, COR stress, β/γ osc
Key Thresholds
verdict ≥ 0.85 EXEMPLARY, ≥ 0.60 ADEQUATE, ≥ 0.35 DEFICIENT, < 0.35 CRITICAL
...
Detail
NT Read (input)
DA (explore strategies), 5-HT (conserve plan), NE (revision trigger), ACh (depth), COR (risk), GABA (prune), CB1 (flexibility)
NT Write (output)
DA explore, 5-HT conserve, NE revision, COR risk, β/θ osc
Key Thresholds
stagnation_threshold=5 cycles, max_goals=64, max_strategies=12/goal


Algorithm
Register goals → Generate strategies per goal (DA-modulated exploration) → Evaluate strategies (multi-criteria scoring) → Commit to best strategy per goal → Track progress → Stagnation detection (5 cycles no improvement) → Plan revision (NE-triggered) → GABA-pruning of stale strategies. Commitment tracking prevents oscillating between plans.
Unique Features
...
Detail
NT Read (input)
ACh (meta-attention), NE (alert), 5-HT2A (flexibility), DA (correction reward)
NT Write (output)
ACh meta-attention, NE alert, 5-HT2A flexibility, DA correction, γ-boost
Key Thresholds
θ_anchoring=0.65, 22 bias types, 4 categories


Algorithm
Detect heuristic biases in system reasoning → Correction authority matrix (which biases can override which) → Reward system health monitoring (domain balance, prediction calibration) → Emit corrections with authority levels.
Unique Features
...
Detail
NT Read (input)
DA (salience_threshold 0.3+0.4×DA), 5-HT (abstraction_level 0.3+0.4×5HT), ACh (precision_factor 0.5+0.5×ACh), NE (urgency_weight 0.3+0.7×NE)
NT Write (output)
Output via nt_modulation dict (DA salience, 5-HT abstraction, ACh precision, NE urgency)
Key Thresholds
recurring_failure_min=2, stagnation_threshold=0.30


Algorithm
Compute per-mode statistics (turns, confirmations, contradictions) → Per-subject proficiency trending (first half vs second half) → Recurring failure detection (error types ≥ min_count) → Meta-pattern identification (comfort zone, confirmation bias risk, underperforming modes) → Rank mode preferences → Generate recommendations.
Unique Features
...
Detail
NT Read (input)
OXT (social_weight 0.3+0.4×OXT), 5-HT (stability_tolerance 0.2+0.3×5HT), DA (self_relevance 0.5+0.3×DA), COR (threat_bias 0.0+0.15×COR)
NT Write (output)
Output via nt_modulation dict (OXT social, 5-HT stability, DA relevance, COR threat)
Key Thresholds
coherence_disrupted=0.40, fragmented=0.70
...
Detail
NT Read (input)
NE (cascade sensitivity), DA (dampen uncertainty), ACh (focus), 5-HT (stability), COR (amplify), GABA (stabilise)
NT Write (output)
NE cascade, DA dampen, ACh focus, COR amplify, GABA stabilise
Key Thresholds
θ_alert=0.50–0.85 (type-dependent)


Algorithm
Classify uncertainty by type (epistemic/aleatoric/model/linguistic) → Propagation analysis: cascade (spreading uncertainty), island (isolated), divergence (growing), stagnation (persistent) → Emotion integration (uncertainty → anxiety/curiosity mapping) → Alert if above type-specific threshold.
Unique Features
...
(monitors all 12 NTs)
NT Write (output)
GABA reactive, 5-HT1A containment, CB1 dampening, NE violation, COR chronic stress
Key Thresholds
overload=0.85, correction levels: gradual→aggressive→hard_reset


Algorithm
Compute cognitive load via sigmoid model → Monitor all 12 NT concentrations against bounds → Classify violations (mild/moderate/severe) → Escalating correction: gradual (small push toward baseline), aggressive (stronger correction), hard_reset (snap to baseline). Dream-mode: creative tolerance (wider bounds, slower corrections).
Unique Features
...
Detail
NT Read (input)
ACh (preserve salience), 5-HT (protect emotional), GABA (accelerate pruning), DA (novelty), COR (stress)
NT Write (output)
5-HT protect, GABA accelerate, ACh salience, α-boost
Key Thresholds
verbatim≥0.75, semantic≥0.50, symbolic≥0.25, prune<0.25


Algorithm
Compute 5-axis information score (entropy + redundancy + salience + recency + access_freq) → Apply override rules (identity→VERBATIM, critical→VERBATIM, unresolved→SEMANTIC, high_emotion→SEMANTIC) → Assign compression policy. ACh preserves high-salience content, 5-HT protects emotionally tagged memories, GABA accelerates pruning of low-value content.
Unique Features
...
Detail
NT Read (input)
OXT, NE, DA, 5-HT, COR, GABA (6 primary + 7 secondary channels)
NT Write (output)
13+ write channels: tonic (OXT, 5-HT1A, GABA) + phasic (DA, NE, OXT, MOR, COR, ACh, GABA) + oscillatory (α, β, θ, γ)
Key Thresholds
θ_detect=0.25, 46 emotions, 7 groups


Algorithm
Phase 1: Feature extraction (lexical, semantic, prosodic markers). Phase 2: Multi-label emotion classification (46 types across 7 groups). Phase 3: Per-emotion NT profile lookup → 13+ channel emission. Phase 4: Arousal estimation. Phase 5: Tone calibration (valence + coherence + warmth + discord). ENOCH override for structural boundary emotions.
Unique Features
...
Detail
NT Read (input)
COR (temporal threat), 5-HT1A (stability), NE (vigilance, Poisson), DA (RPE ±), OXT (trust decay/repair)
NT Write (output)
COR stress (0.12), 5-HT1A calm, NE alert (Poisson λ=1.5), DA RPE (Gamma 2.0/0.3), OXT trust, θ/γ/αθ/β/δ osc
Key Thresholds
collapse: STABLE(<0.15), ELEVATED(0.15-0.30), AT_RISK(0.30-0.50), CRITICAL(0.50-0.70), COLLAPSE_IMMINENT(≥0.70)


Algorithm
Project past state forward (accounting for acknowledged changes) → Compute 3 deltas: δ_sym(1-cosine), δ_aff(Euclidean), δ_rew(Euclidean) → Collapse probability via sigmoid with interaction term (sym×aff + sym×rew + aff×rew) → EWMA smoothing with hysteresis (τ=4, t_hysteresis=2) → Attribution (SELF/OTHER/SYSTEM/UNKNOWN) → Corrections: symbolic_contradiction, affective_bridge, memory_trust, reward_recalibration → NT emission based on attribution type.
Unique Features
...
Detail
NT Read (input)
DA (LR boost +0.30), 5-HT (stability damp -0.25), NE (urgency +0.20), ACh (credit depth +0.15), GABA (noise gate +0.20), OXT (social domain +0.15), CB1 (explore in REM +0.20), COR (stress penalty -0.15)
NT Write (output)
DA RPE (Gamma 2.0/0.3), 5-HT stability, NE surprise (Poisson λ=1.5 if |δ|>0.15), ACh depth, θ/γ/β osc
Key Thresholds
LR_initial=0.10, convergence=0.02 (window 10), consolidation=0.015 (window 15)
...
Detail
NT Read (input)
ACh (strengthen encoding +0.15), OXT (social sensitivity +0.12), CB1 (lower threshold +0.10), DA (novel context reward +0.12), 5-HT (stabilise records -0.08), NE (broaden features +0.10)
NT Write (output)
DA novel context, ACh encoding, OXT social, 5-HT stability, θ-boost (encoding), γ-boost (recognition)
Key Thresholds
θ_recognition=0.60, max_contexts=512, decay_half_life=500 ticks


Algorithm
Build ContextFingerprint (topic→32-dim, emotion→16-dim, intent→32-dim via n-gram hashing) → Match against stored records (weighted cosine: topic=0.45, emotion=0.30, intent=0.25) → Classify match quality (EXACT≥0.95, STRONG≥0.80, MODERATE≥θ) → If match: retrieve parameter adjustments + strengthen record (EMA blend 0.20). If no match: encode new context. Lifecycle decay: exp(-λ×ticks).
Unique Features
...
Detail
NT Read (input)
DA (explore probability +0.15), 5-HT (exploit preference -0.12), NE (urgency amplifies divergence +0.10), ACh (deepen analysis +0.08), GABA (smooth meta-metrics +0.10)
NT Write (output)
DA explore/improvement, 5-HT exploit, NE divergence, ACh analysis, GABA smooth, β-boost
Key Thresholds
plateau_var=0.001, divergence_slope=0.005, explore_probability=0.25


Algorithm
Update performance window (20 cycles of mean_abs_δ, convergence_ratio, LR) → Linear regression for trend → Detect plateau (low variance + convergence < 0.80 for ≥5 cycles) → Detect divergence (positive slope + mean_δ > 0.30 for ≥3 cycles) → Compute explore probability (DA+, 5-HT-, plateau+0.30, divergence-0.15) → Strategy decision: RESET on divergence, EXPLORE on plateau, EXPLOIT otherwise → Emit meta-parameter adjustments → Meta-LR decay (×0.95/cycle).
Unique Features
...
NT levels raise/lower detection thresholds
E1, E2, E4, E5, E6, E8, E19, E20
Burst emission
NT delta output proportional to engine activity
E1 (DA D2), E4 (ACh), E5 (ACh/NE), E6 (NE), E28 (phasic)
Poisson alert
Stochastic NE burst on high-confidence detections
E4, E5, E6, E14, E17, E25, E26
Drift/decay
Sustained NT shift for persistent conditions
E2 (CB1), E6 (COR), E28 (OXT tonic), E30 (COR)
Bidirectional
Both reads NT state AND emits NT deltas
E1, E2, E4, E5, E6, E28, E30
Matrix burst
Multi-channel NT burst from classification
E23 (11-channel B_intent), E28 (13+ channels)
Oscillatory
α/β/γ/θ/δ/σ boost/suppress signals
All engines emit at least 1
...
Typical Parameters
Gamma(α, θ)
NT burst magnitude (ACh, DA, NE)
α=2.0–3.0, θ=0.25–0.50
Poisson(λ)
NE alert events
λ=1.5–2.5
LogNormal(μ, σ)
Discharge/symbolic intent noise
μ=-0.5–0.0, σ=0.7–1.0
Beta(α, β)
Bayesian classification priors
Varies per class
...
E3 (SOAR)
E26 (Uncertainty)
STATE_NO_CHANGE impasse
E4 (Fallacy)
E6 (Logic Trap)
manipulation_indicator > 0.50
E2 (Paradox)
Unsolved Concepts Buffer
Genuine paradox (Class G)
E7 (Opposition)
E2 (Paradox)
Structural resistance → paradox candidate
...
Typical Effect
NORMAL
Default conversational processing
Balanced thresholds
DEV
Developer/diagnostic mode
Lower thresholds, more verbose
LEARNING (M1–M5)
Active learning session
Higher sensitivity, faster LR
REFLECTIVE
Self-reflective processing
Deeper analysis, identity focus
REM_NORMAL
Normal sleep consolidation
Standard thresholds
REM_DREAM
Creative dream processing
Very low thresholds, high noise tolerance
